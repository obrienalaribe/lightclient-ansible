...
module "bootnode" {
  ...
  node_type       = "bootnode"
  region          = "ams3"
  tags            = ["role:bootnode", "Lightclient-Turing", "Network:turing", "Role:bootnode"]
  network         = var.network
...
module "otel" {
  ...
  node_type       = "otel"
  region          = "ams3"
  tags            = ["role:otel", "Lightclient-Turing", "Network:turing"]
  network         = var.network
  ssh_fingerprint = [digitalocean_ssh_key.key.fingerprint]
  project         = data.digitalocean_project.project
}
...
module "lightnode" {
  ...
  node_type       = "lightnode"
  region          = "ams3"
  tags            = ["role:lightnode", "Lightclient-Turing", "Network:turing"]
  network         = var.network
  ssh_fingerprint = [digitalocean_ssh_key.key.fingerprint]
  project         = data.digitalocean_project.project
...
module "fatclient" {
  ...
  node_type       = "fatclient"
  region          = "ams3"
  tags            = ["role:fatclient", "Lightclient-Turing", "Network:turing"]
  network         = var.network
  ssh_fingerprint = [digitalocean_ssh_key.key.fingerprint]
  project         = data.digitalocean_project.project
}
